...
import '../../../../core/widgets/offline_indicator_widget.dart' hide PendingRecordsIndicator;
import '../providers/attendance_provider.dart';
import '../widgets/pending_records_indicator.dart';
...
class _CheckOutScreenState extends ConsumerState<CheckOutScreen> {
  ...
  Future<void> _checkAttendanceStatus() async {
    // Just verify we're in check-out mode
    ...
    if (!todayAttendance.hasCheckedIn || todayAttendance.hasCheckedOut) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('You must check in first to check out'),
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      // For checkout, use front camera for selfie
  ...
  Future<void> _handleCheckOut() async {
    ...
    final success = await ref.read(checkInOutProvider.notifier).checkOut(
    ...
    if (success) {
      ...
      _showSuccess(message ?? 'Successfully checked out');
      ...
      final error = ref.read(checkInOutProvider).error ?? 'Checkout failed';
      _showError(error);
    }
  }
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          ...
                          '3. Capture your checkout selfie\n'
                          '4. Submit to complete checkout',
                          style: TextStyle(
                            fontSize: 12,
                ...
                // Checkout Button (red theme for emphasis)
                FilledButton(
                  onPressed: checkInOutState.isLoading ? null : _handleCheckOut,
